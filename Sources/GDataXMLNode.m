...
+ (NSString *)prettyPrintXMLData:(NSData *)rawXMLData {
    NSError *error;

    GDataXMLDocument *doc = [[GDataXMLDocument alloc] initWithData:rawXMLData options:0 error:&error];
    return error ? nil : doc.rootElement.XMLString;
}
